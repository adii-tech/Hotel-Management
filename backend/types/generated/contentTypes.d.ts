...
export interface ApiCampaignCampaign extends Schema.CollectionType {
  ...
  attributes: {
    roombooked: Attribute.Integer;
    roomvisited: Attribute.Integer;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiUserListUserList extends Schema.CollectionType {
  ...
  attributes: {
    ...
    rooms: Attribute.Enumeration<
      ['Double', 'Single', 'Queen room', 'Hospitality room']
    >;
    sdate: Attribute.Date;
    edate: Attribute.Date;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
